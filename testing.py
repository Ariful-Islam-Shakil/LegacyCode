...
def exception_handling_demo() -> str:
    """Demonstrate exception handling with a division by zero example.
...
def main() -> None:
    """Main function to demonstrate various utility functions."""
    ...
    print("Word Counts:")
    for word, count in word_count.items():  # Python 3.x style dictionary iteration
        print(f"{word}: {count}")
